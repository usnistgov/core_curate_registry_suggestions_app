...
setup(
    name="core_curate_registry_suggestions_app",
    version="1.0.0-alpha1",
    description="Curation suggestions functionalities specific to Registry applications for the curator core project",
    long_description=long_desc,
    author="NIST IT Lab",
    author_email="itl_inquiries@nist.gov",
    url="https://github.com/usnistgov/core_curate_registry_suggestions_app",
